package com.example.finalyearprojectu.home.missingRecycleView;

public class MissingPersonR {
String address;
String age;
String city;
String disappeared_date;
String dissappeared_city;
String gender;
String image_url;
String missing_key;
String missing_name;
...
public MissingPersonR() {

    }

    public MissingPersonR(String address, String age, String city,
                          String disappeared_date,
                          String dissappeared_city, String gender,
                          String image_url, String missing_key,
                          String missing_name, String missing_status,
                          String phone_number, String user_key) {
