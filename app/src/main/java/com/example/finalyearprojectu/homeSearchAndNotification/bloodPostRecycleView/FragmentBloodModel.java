...
public class FragmentBloodModel {
    ...
    public FragmentBloodModel() {
    }

    public FragmentBloodModel(String age, String blood_for, String blood_group,
                              String full_address, String gender,
                              String phone_number, String refer_city,
                              String request_key, String request_type, String user_key) {
        this.age = age;
