...
public class MissingPersonHomM {
    ...
    public MissingPersonHomM() {
    }

    public MissingPersonHomM(String address, String age, String city, String disappeared_date,
                             String dissappeared_city, String gender, String image_url,
                             String missing_key, String missing_name, String missing_status,
